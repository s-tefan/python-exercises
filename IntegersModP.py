# Efter https://jeremykun.com/2014/03/13/programming-with-finite-fields/
def IntegersModP(p):
      #Definierar en klass IntegerModP som ärver FieldElement(?)
#   class IntegerModP(FieldElement):
      #Definierar en klass IntegerModP
   class IntegerModP:
      def __init__(self, n):
         self.n = n % p
      ...
      def __pow__(self, m): return IntegerModP(pow(self.n,m,self.p))
      ...
      def inverse(self):
         x,y,d = extendedEuclidianAlgorithm(self.n,self.p)
